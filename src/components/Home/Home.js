  ...
  return (
    <div className="min-h-screen">
      <div className="vignette relative h-screen flex flex-col justify-center items-center">
        ...
        <h2 className="z-10 text-gray-300 text-xl text-center px-6 m-4">A digital miniature wargame on Babylon.js.</h2>
        <h2 className="z-10 text-gray-300 text-xl">Connect - Draft - Fight</h2>
